...
<div class="container generic-form">
	<h2>Comercial</h2>
	<hr>
	<form  action="php/data-base-comerciales-consultar.php" method="post"  autocomplete="off">
		...
		<div class="form-group">
			...
			<?php
		    	...
		    	echo '<input type="text" class="form-control" name="Nombre_comercial" required  disabled value="'.$nombre_comercial.'">';
			?>
		</div>
		...
		<div class="form-group">
			...
			<?php
		    	...
		    	echo '<input type="text" class="form-control" name="Apellidos_comercial" disabled required value="'.$apellidos_comercial.'">';
			?>
		</div>
		...
		<div class="form-group">
			...
			<?php
				...
				$row=mysqli_fetch_array($result);
		    	$Dni= $row[0];
		    	echo '<input type="text" class="form-control" name="Dni" required disabled value="'.$Dni.'">';
			?>
		</div>	
		...
		<div class="form-group">
			...
			<?php
		    	...
		    	echo '<input type="text" class="form-control" name="Direccion_comercial" disabled value="'.$direccion_comercial.'">';
			?>
		</div>
		...
		<label for="telefono_comercial">Teléfono</label>
			<?php
		    	...
		    	echo '<input type="tel" class="form-control" name="Telefono" disabled value="'.$telefono_contacto.'">';
			?>
		</div>
		...
		<?php
		    ...
		    echo '<input type="tel" class="form-control" name="Movil" disabled value="'.$telefono_movil.'">';
			?>
		</div>

		<div class="form-group">
		<label for="telefono_comercial">Email</label>
			<?php
		    	$id = isset($_GET['id']) ? $_GET['id'] : 'Not id foud';
				...
				$row=mysqli_fetch_array($result);
		    	$email= $row[0];
		    	echo '<input type="email" class="form-control" name="Email" disabled value="'.$email.'">';
			?>
		</div>

		<div class="form-group">
		<label for="nombre_usuario_comercial">Nombre usuario</label>
			<?php
		    	$id = isset($_GET['id']) ? $_GET['id'] : 'Not id foud';
				...
				$row=mysqli_fetch_array($result);
		    	$user_name= $row[0];
		    	echo '<input type="text" class="form-control" name="Email" disabled value="'.$user_name.'">';
			?>
		</div>
